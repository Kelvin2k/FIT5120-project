export default {
  en: {
    ...
    footer: {
      support: 'Supporting Older Adults in Australia',
      subtitle:
        'Empowering older adults with essential knowledge and skills for a confident, independent life in Australia.',
      ...
      dailyLifeGuide: 'Daily Life Guide',
      transportGuide: 'Transport Guide',
      localFacilities: 'Local Facilities',
    ...
    safety: {
      ...
      very_low_crime: 'Very Low',
      low_crime: 'Low',
      medium_crime: 'Medium',
      high_crime: 'High',
      very_high_crime: 'Very High',
      points_explanation:
  ...
  zh: {
    ...
    footer: {
      support: '支持澳大利亚老年人',
      subtitle: '赋能老年人，掌握必要的知识和技能，自信独立地生活在澳大利亚。',
      learningfeatures: '学习功能',
      lifenavigation: '生活导航',
      safetyandsupport: '安全与支持',
      englishlearning: '学英语',
      aiassistant: 'AI学习伙伴',
      knowledgequizzes: '知识测验',
      dailyLifeGuide: '日常生活指南',
      transportGuide: '交通指南',
      localFacilities: '本地设施',
      socialEtiquette: '社交礼仪',
      safetyInformation: '安全信息',
  ...
  vi: {
    ...
    footer: {
      support: 'Hỗ trợ người cao tuổi Úc',
      subtitle:
        'Trao quyền cho người cao tuổi nắm bắt kiến thức và kỹ năng cần thiết để sống tự tin và độc lập tại Úc.',
      learningfeatures: 'Tính năng học tập',
      lifenavigation: 'Điều hướng cuộc sống',
      safetyandsupport: 'An toàn & Hỗ trợ',
      englishlearning: 'Học tiếng Anh',
      aiassistant: 'Trợ lý AI',
      knowledgequizzes: 'Kiến thức & Câu đố',
      dailyLifeGuide: 'Hướng dẫn cuộc sống hàng ngày',
      transportGuide: 'Hướng dẫn giao thông',
      localFacilities: 'Cơ sở vật chất địa phương',
      socialEtiquette: 'Phép lịch sự xã hội',
      safetyInformation: 'Thông tin an toàn',
      emergencyResources: 'Tài nguyên khẩn cấp',
      healthServices: 'Dịch vụ y tế',
      available: ' Có sẵn 24/7',
  ...
  id: {
    ...
    footer: {
      support: 'Mendukung Lansia Australia',
      subtitle:
        'Memberdayakan lansia dengan pengetahuan dan keterampilan yang mereka butuhkan untuk hidup percaya diri dan mandiri di Australia.',
      learningfeatures: 'Fitur Pembelajaran',
      lifenavigation: 'Navigasi Kehidupan',
      safetyandsupport: 'Keamanan & Dukungan',
      englishlearning: 'Belajar Bahasa Inggris',
      aiassistant: 'Asisten AI',
      knowledgequizzes: 'Pengetahuan & Kuis',
      dailyLifeGuide: 'Panduan Kehidupan Sehari-hari',
      transportGuide: 'Panduan Transportasi',
      localFacilities: 'Fasilitas Lokal',
      socialEtiquette: 'Etiket Sosial',
      safetyInformation: 'Informasi Keamanan',
      emergencyResources: 'Sumber Daya Darurat',
